...
COPY --from=builder --chown=bioma:bioma /app/tools/cognition/templates /app/tools/cognition/templates
COPY --from=builder --chown=bioma:bioma /app/tools/cognition/docs /app/tools/cognition/docs
...
COPY --chown=bioma:bioma assets/configs/rag_config_server_runpod.json /app/assets/configs/
