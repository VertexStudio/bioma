...
#[derive(utoipa::ToSchema, schemars::JsonSchema, bon::Builder, Debug, Clone, Serialize, Deserialize)]
...
#[derive(utoipa::ToSchema, schemars::JsonSchema, Debug, Clone, Serialize, Deserialize)]
